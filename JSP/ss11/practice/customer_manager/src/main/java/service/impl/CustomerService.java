...
public class CustomerService implements ICustomerService {
    ...
    static {
        ...
        customers.put(6, new Customer(6, "Yua", "yua@codegym.vn", "Newyork"));
        customers.put(7, new Customer(6, "Mikami", "mikami@codegym.vn", "Osaka"));
    }
    ...
    public Customer findById(int id) {
        return customers.get(id);//get key, mà key trùng với id
    }
